...
class RouterApiConfig:
    ...
    # Compaction settings
    COMPACTION_TOKEN_THRESHOLD: int = _get_int("COMPACTION_TOKEN_THRESHOLD", 195000)
    CLAUDE_CODE_COMPACTION_THRESHOLD: int = _get_int("CLAUDE_CODE_COMPACTION_THRESHOLD", 195000)
    COMPACTION_TARGET_LIMIT: int = _get_int("COMPACTION_TARGET_LIMIT", 160000)
    CLAUDE_CODE_COMPACTION_TARGET_LIMIT: int = _get_int("CLAUDE_CODE_COMPACTION_TARGET_LIMIT", 160000)
    EMERGENCY_MAX_INPUT_TOKENS: int = _get_int("EMERGENCY_MAX_INPUT_TOKENS", 200000)
    ...
    # Pool (model merge)
    POOL_SWAP_FAILURES: int = _get_int("POOL_SWAP_FAILURES", 5, 1, 15)
    POOL_MAX_ATTEMPTS: int = _get_int("POOL_MAX_ATTEMPTS", 13, 1, 30)
    POOL_RETRY_SECONDS: int = _get_int("POOL_RETRY_SECONDS", 120, 10, 600)
